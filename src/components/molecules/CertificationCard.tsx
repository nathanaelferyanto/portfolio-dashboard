      ...
      {isOpen && hasMedia && (
        ...
        >
          ...
          >
            ...
            {hasMedia && (
              <div
                className={`relative w-full rounded-2xl ${images.length > 1 ? 'overflow-y-auto p-4' : 'overflow-hidden'} bg-white dark:bg-zinc-900 shadow-2xl border border-white/10`}
                ...
                {images.length === 1 ? (
                  ...
                  <div className="flex flex-col gap-6">
                    {images.map((imgUrl, idx) => (
                      <div key={idx} className="relative w-full" style={{ minHeight: "80vh" }}>
                        <Image
                          src={imgUrl}
                          alt={`${title} certificate page ${idx + 1}`}
                          fill
                          className="object-contain"
                          sizes="(max-width: 768px) 100vw, 1024px"
                          quality={95}
